...
const SUBJECTS = [
  { id: 1, emoji: '🔬', title: 'IPA', topic: 'Biologi Sel & Genetika', progress: 55, xp: 210, color: '#F0FDF4', route: '/dashboard/sma/materi/ipa' },
  { id: 2, emoji: '📖', title: 'Bahasa Indonesia', topic: 'Teks Argumentasi & Esai', progress: 83, xp: 410, color: '#FFF7ED', route: '/dashboard/sma/materi/bahasa-indonesia' },
  { id: 3, emoji: '🌐', title: 'Bahasa Inggris', topic: 'Reading Comprehension', progress: 61, xp: 290, color: '#F0F9FF', route: '/dashboard/sma/materi/bahasa-inggris' },
];
  ...
  return (
    <div className="dash-page">
      <aside className="sidebar">
        ...
        <div className="sb-badge-jenjang">SMA</div>

        <div className="sb-user">
          <div className="sb-av">{initials}</div>
          <div>
            <div className="sb-name">{user?.name || "Siswa"}</div>
            <div className="sb-kelas">{user?.kelas || "SMA"}</div>
          </div>
      ...
      <main className="dash-main">
        ...
        {activeTab === 'beranda' && (
          <div className="tab-content">
            ...
            <div className="section-title">📚 Progress Mata Pelajaran SMA</div>
        ...
        {activeTab === 'materi' && (
          <div className="tab-content">
            <div className="section-title">📚 Materi SMA</div>
            <div className="subject-grid">
              {SUBJECTS.map(s => (
