...
const SUBJECTS = [
  { id: 1, emoji: '🔬', title: 'IPA', topic: 'Makhluk Hidup & Lingkungan', progress: 55, xp: 210, color: '#F0FDF4', route: '/dashboard/sd/materi/ipa' },
  { id: 2, emoji: '📖', title: 'Bahasa Indonesia', topic: 'Teks Cerita & Dongeng', progress: 83, xp: 410, color: '#FFF7ED', route: '/dashboard/sd/materi/bahasa-indonesia' },
  { id: 3, emoji: '🌐', title: 'Bahasa Inggris', topic: 'Greetings & Introduction', progress: 61, xp: 290, color: '#F0F9FF', route: '/dashboard/sd/materi/bahasa-inggris' },
];

const ACTIVITIES = [
  { emoji: '✅', text: 'Menyelesaikan latihan Penjumlahan — Bab 3', time: '2 jam lalu', xp: '+20 XP' },
  { emoji: '🏆', text: 'Naik ke Level 2!', time: '1 hari lalu', xp: '+50 XP' },
  { emoji: '📖', text: 'Membaca materi Makhluk Hidup', time: '1 hari lalu', xp: '+10 XP' },
  ...
  return (
    <div className="dash-page">
      <aside className="sidebar">
        ...
        <div className="sb-badge-jenjang">SD</div>

        <div className="sb-user">
          <div className="sb-av">{initials}</div>
          <div>
            <div className="sb-name">{user?.name || "Siswa"}</div>
            <div className="sb-kelas">{user?.kelas || "SD"}</div>
          </div>
      ...
      <main className="dash-main">
        ...
        {activeTab === 'beranda' && (
          <div className="tab-content">
            ...
            <div className="section-title">📚 Progress Mata Pelajaran SD</div>
        ...
        {activeTab === 'materi' && (
          <div className="tab-content">
            <div className="section-title">📚 Materi SD</div>
            <div className="subject-grid">
              {SUBJECTS.map(s => (
